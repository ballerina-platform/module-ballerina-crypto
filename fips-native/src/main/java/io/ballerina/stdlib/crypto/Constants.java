...
public class Constants {
    ...
    // Crypto FIPS error
    static final String CRYPTO_FIPS_ERROR = "FipsError";
    ...
    // FIPS error message suffix
    public static final String NOT_SUPPORTED_IN_FIPS_MODE = " is not currently supported in FIPS mode";
}
