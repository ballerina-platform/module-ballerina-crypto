...
import static io.ballerina.stdlib.crypto.Constants.CRYPTO_FIPS_ERROR;
...
public class CryptoUtils {
    ...
    public static BError createError(String errMsg) {
        return ErrorCreator.createError(ModuleUtils.getModule(), CRYPTO_ERROR, StringUtils.fromString(errMsg), null,
                null);
    }

    /**
     * Create crypto error related to FIPS restrictions.
     *
     * @param errMsg error description
     * @return FIPS error
     */
    public static BError createFipsError(String errMsg) {
        return ErrorCreator.createError(ModuleUtils.getModule(), CRYPTO_FIPS_ERROR, StringUtils.fromString(errMsg),
                null, null);
    }
