...
@test:Config {}
isolated function testHmacMd5() returns Error? {
...
@test:Config {}
isolated function testHmacSha1() returns Error? {
    byte[] message = "Ballerina HMAC test".toBytes();
    byte[] key = "abcdefghijk".toBytes();
...
@test:Config {}
isolated function testHmacSha256() returns Error? {
    byte[] message = "Ballerina HMAC test".toBytes();
    byte[] key = "abcdefghijk".toBytes();
...
@test:Config {}
isolated function testHmacSha384() returns Error? {
    byte[] message = "Ballerina HMAC test".toBytes();
    byte[] key = "abcdefghijk".toBytes();
...
@test:Config {}
isolated function testHmacSha512() returns Error? {
    byte[] message = "Ballerina HMAC test".toBytes();
    byte[] key = "abcdefghijk".toBytes();
