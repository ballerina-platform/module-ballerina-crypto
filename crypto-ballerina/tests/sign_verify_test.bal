...
isolated function testSignRsaMd5() {
    ...
    byte[] md5Signature = checkpanic signRsaMd5(payload, privateKey);
...
isolated function testSignRsaSha1() {
    ...
    byte[] sha1Signature = checkpanic signRsaSha1(payload, privateKey);
...
isolated function testSignRsaSha256() {
    ...
    byte[] sha256Signature = checkpanic signRsaSha256(payload, privateKey);
...
isolated function testSignRsaSha384() {
    ...
    byte[] sha384Signature = checkpanic signRsaSha384(payload, privateKey);
...
isolated function testSignRsaSha512() {
    ...
    byte[] sha512Signature = checkpanic signRsaSha512(payload, privateKey);
...
isolated function testVerifyRsaMd5() {
    ...
    string expectedMd5Signature = "457050eca794baf2149f53631f373525fbc7b40de83e0af5b03473e7b726064b" +
        ...
        "67145ec0e6e8abfc3f7f10122cc278b5469eb970034483839f290eec";
    byte[] md5Signature = checkpanic signRsaMd5(payload, privateKey);
    test:assertTrue(checkpanic verifyRsaMd5Signature(payload, md5Signature, publicKey));
}
...
isolated function testVerifyRsaSha1() {
    ...
    string expectedSha1Signature = "70728d6d37fd83704bcb2649d93cfd20dbadb83a9d2169965d2a241795a131f" +
        ...
        "02f7840f8991b8c335b0332b3b4bd658030ec3007f6f36c190b8663d3b746";
    byte[] sha1Signature = checkpanic signRsaSha1(payload, privateKey);
    test:assertTrue(checkpanic verifyRsaSha1Signature(payload, sha1Signature, publicKey));
}
...
isolated function testVerifyRsaSha256() {
    ...
    string expectedSha256Signature = "34477f0e0a5457ca1a95049da10d59baa33ee4fa9e1bb8be3d3c70d82b980850" +
        ...
        "0c11ef2a0d32088d4683d915005c9dcc8137611e5bff9dc4a5db6f87";
    byte[] sha256Signature = checkpanic signRsaSha256(payload, privateKey);
    test:assertTrue(checkpanic verifyRsaSha256Signature(payload, sha256Signature, publicKey));
}
...
isolated function testVerifyRsaSha384() {
    ...
    string expectedSha384Signature = ("4981CC5213F384E8DB7950BF76C97AE20FA2A34244A517FC585B2381B9E88" +
        ...
        "EF7D8F8BF0659E1D6B77916B4AEEC79989AFDAA2F5B8983DE476C1A0FFBB2B647DE449E").toLowerAscii();
    byte[] sha384Signature = checkpanic signRsaSha384(payload, privateKey);
    test:assertTrue(checkpanic verifyRsaSha384Signature(payload, sha384Signature, publicKey));
}
...
isolated function testVerifyRsaSha512() {
    ...
    string expectedSha512Signature = "6995ba8d2382a8c4f0ed513033126b2305df419a8b105ee60483243229d2c496" +
        ...
        "9cb2e6e669ec3352073a8933a2a0cac6056b4997b3628132f7a7e553";
    byte[] sha512Signature = checkpanic signRsaSha512(payload, privateKey);
    test:assertTrue(checkpanic verifyRsaSha512Signature(payload, sha512Signature, publicKey));
}
