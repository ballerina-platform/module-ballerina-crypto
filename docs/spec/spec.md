...
stream<byte[], crypto:Error?>|crypto:Error encryptedStream = crypto:encryptStreamPgp(inputStream, "public_key.asc");
```
...
stream<byte[], crypto:Error?>|crypto:Error decryptedStream = crypto:decryptStreamPgp(inputStream, "private_key.asc", passphrase);
```
